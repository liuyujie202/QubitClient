...
1. main()函数
    ...
    ```python
        ...
        trans_all_npy = send_npy_to_server(API_URL, API_KEY, dict_list)  # trans_all_npy的数据格式参考format_s21vflux.json
    ```
   
        
# 注意事项！！！！！
1. trans_all_npy = send_npy_to_server(API_URL, API_KEY, dict_list)  # trans_all_npy的数据格式参考format_s21vflux.json  
